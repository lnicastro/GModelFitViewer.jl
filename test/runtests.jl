...
GFitViewer.save_json(filename="gfitviewer_test02.json", best, res, data)
GFitViewer.save_json(filename="gfitviewer_test03.json", rebin=2, best)
GFitViewer.save_json(filename="gfitviewer_test04.json", rebin=2, best, res, data,
